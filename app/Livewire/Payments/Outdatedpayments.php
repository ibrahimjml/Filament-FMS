...
class Outdatedpayments extends Component implements HasTable, HasSchemas, HasForms
{
  ...
  {
    $this->count = $service->overdue()->count();
  }
  ...
  {
    return view('livewire.payments.outdatedpayments');
  }
}
